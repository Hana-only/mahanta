...
// Ambil data gambar dan kategori dari database
$sql = "SELECT 
            g.id, 
            g.gambar, 
            g.author, 
        ...
        GROUP BY g.id"; // Group by untuk memastikan jumlah like dihitung per gambar
...
<div class="card shadow mb-4">
    ...
    if ($result->num_rows > 0) {
        while ($row = $result->fetch_assoc()) {
            ...
            echo "<td><img src='uploads/" . $row['gambar'] . "' width='100' alt='art image'></td>";
            echo "<td>" . $row['like_count'] . "</td>"; // Menampilkan jumlah like
            echo "<td>
                <a href='upart2.php?id=" . $row['id'] . "' class='btn btn-sm btn-primary'><i class='bi bi-pencil-square'></i></a>
                <a href='delete.php?id=" . $row['id'] . "' class='btn btn-sm btn-outline-danger' onclick='return confirm(\"Are you sure you want to delete this item?\")'><i class='bi bi-trash3'></i></a>
